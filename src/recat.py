...
<span class="chg" id="chg">0 changed</span><button class="sec" id="regroup">Regroup</button><button id="dl">⬇ Download decisions</button><button class="sec" id="reset">Reset</button><a class="editcats" href="screensort-config-editor.html" target="_blank" title="Add, rename or recolor categories — takes effect on your next run">⚙ Edit categories</a></div>
